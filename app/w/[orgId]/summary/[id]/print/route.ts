...
interface Params { params: { orgId: string; id: string } }
...
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  const formattedDate = new Date(summary.summaryDate).toLocaleDateString("en-US", {
    weekday: "long", year: "numeric", month: "long", day: "numeric",
  });
  const formattedGenerated = new Date(summary.createdAt).toLocaleString("en-US", {
...
<div class="page">
  ...
  <div class="footer">
    ...
    <span>Generated by OrgPulse AI</span>
  </div>
</div>
<script>
