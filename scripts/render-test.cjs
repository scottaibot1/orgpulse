#!/usr/bin/env node
// render-test.cjs — generates orgrise-current-render.html from report-renderer.ts
// Run: node_modules/.bin/jiti scripts/render-test.cjs
// OR:  node -r node_modules/jiti/register scripts/render-test.cjs
...
const { renderPdfHtml } = jitiLoader(path.join(__dirname, '../lib/report-renderer.ts'));
  ...
  departments: [
    {
      ...
      people: [
        {
          name: "Alan Arceo Mejia",
          status: "fresh",
          isStandIn: false,
          daysSinceReport: 0,
          hoursWorked: 9.2,
          timeAllocationEstimated: false,
          timeAllocation: [
          ...
          highlights: [
            ...
            { type: "atrisk", subcategory: "Marketing Initiatives", text: "Clean email list — blocked waiting on emails to be finalized, high priority (0% complete, due 3/31)" },
            ...
            { type: "tomorrowfocus", text: "Complete direct booking conversion for AP VRBO customer" },
            { type: "tomorrowfocus", text: "Ensure PP group coordination remains on track" },
          ],
        },
        {
          name: "Antonio Salazar Ancona",
          status: "fresh",
          isStandIn: false,
          daysSinceReport: 0,
          hoursWorked: 9.3,
          ...
          highlights: [
            ...
            { type: "tomorrowfocus", text: "Continue PP and FFE quote preparation as requested" },
            { type: "tomorrowfocus", text: "Identify opportunities to convert active inquiries into confirmed bookings" },
          ],
        },
      ],
    },
      ...
      people: [
        {
          ...
          highlights: [
            { type: "ontack", subcategory: "Hot Leads", text: "Laura Kessler — very hot, guiding toward commitment and next steps" },
            ...
            { type: "atrisk", subcategory: "Hot Leads", text: "63 hot-but-cold leads — qualified for weeks, multiple follow-ups, zero response" },
            ...
            { type: "tomorrowfocus", text: "Send retreat leader and concierge forms once approved" },
          ],
        },
      ],
    },
    {
      ...
      people: [
        {
          name: "Arturo Montes de Oca",
          status: "fresh",
          isStandIn: false,
          daysSinceReport: 0,
          hoursWorked: null,
          timeAllocationEstimated: true,
          overflowNote: '3 additional tasks in pipeline — <a style="color:#818cf8;font-size:11px;text-decoration:none;" href="#">view full report</a>',
          timeAllocation: [
          ...
          highlights: [
            ...
            { type: "atrisk", subcategory: "Food & Beverage", text: "Smoothies project — approved by John, waiting on creative team next steps (90% complete, due 3/31)" },
            { type: "ontack", subcategory: "Facilities & Maintenance", text: "Mirrors at Club 33 — 1 of 3 quotes received, sourcing 2 more (10% complete, due 4/15)" },
            { type: "atrisk", subcategory: "Facilities & Maintenance", text: "Telmex WiFi intensity — line working but not optimal (80% complete, due 3/30)" },
            { type: "ontack", subcategory: "Facilities & Maintenance", text: "Elevator — working to get liftchair refund approved (10% complete, due 7/1)" },
            { type: "atrisk", subcategory: "Facilities & Maintenance", text: "In-house waterslide sealing — materials received, work pending (70% complete, due 4/10/25)" },
            { type: "atrisk", subcategory: "Facilities & Maintenance", text: "A/C units preventive maintenance units 1–5 — waiting on vacancy (50% complete, due 4/10/25)" },
            { type: "atrisk", subcategory: "Facilities & Maintenance", text: "Pavers — sourcing 3rd vendor quote per John's request (25% complete, due 3/31)" },
            { type: "ontack", subcategory: "Staff & HR", text: "Staff vacation conciliation — contracts reviewed, comparing against Adriana's chart (70% complete, due 4/1)" },
            { type: "ontack", subcategory: "Staff & HR", text: "Welcome to PP video — continuing until John confirms sufficient content (90% complete, due 3/31)" },
            { type: "atrisk", subcategory: "Security & Operations", text: "PP security cost-saving proposal — never started (0% complete, due 3/31)" },
            { type: "tomorrowfocus", text: "Supervise Resendiz collecting waterslide screw adjustment data per John's instructions" },
            { type: "tomorrowfocus", text: "Follow up with Scott on smoothies, taxi price comparison, and elevator quotations" },
            { type: "tomorrowfocus", text: "Provide operational support during breakfast and lunch" },
            { type: "tomorrowfocus", text: "Send photo of the activity board" },
          ],
        },
      ],
    },
    {
      ...
      reportedCount: 0,
      totalCount: 1,
      statusLabel: "reports weekly on Fridays",
      statusOk: false,
      notExpectedToday: true,
      scheduleLabel: "reports weekly on Fridays",
      people: [],
    },
    {
      name: "Marketing",
...
const html = renderPdfHtml(data, ctx);
const outPath = path.join(__dirname, '../orgrise-current-render.html');
