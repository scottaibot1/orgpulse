#!/usr/bin/env node
// render-test.mjs — generates orgrise-current-render.html from report-renderer.ts
// Run: node_modules/.bin/jiti scripts/render-test.mjs
...
const { renderPdfHtml } = jitiLoader(join(__dirname, '../lib/report-renderer.ts'));
...
const outPath = join(__dirname, '../orgrise-current-render.html');
